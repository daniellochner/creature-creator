...
namespace DanielLochner.Assets.CreatureCreator
{
    public class ExtremityEditor : BodyPartEditor
    {
        ...
        {
            if (Physics.Raycast(RectTransformUtility.ScreenPointToRay(CreatureEditor.Camera.MainCamera, Input.mousePosition), out RaycastHit hitInfo, Mathf.Infinity, LayerMask.GetMask("Body Parts")))
            {
