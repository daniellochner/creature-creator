...
namespace DanielLochner.Assets.CreatureCreator
{
    ...
    public class CreatureMover : MonoBehaviour
    {
        ...
        public bool CanInput
        {
            get
            {
                return !CinematicManager.Instance.IsInCinematic && EditorManager.Instance.IsPlaying && !InputDialog.Instance.IsOpen && !ConfirmationDialog.Instance.IsOpen && !InformationDialog.Instance.IsOpen && !PauseMenu.Instance.IsOpen && (!PlayerChatMenu.Instance || !PlayerChatMenu.Instance.IsOpen);
            }
        }
