...
namespace DanielLochner.Assets.CreatureCreator
{
    public class CreatureRideable : CreatureInteractable
    {
        ...
        {
            return base.CanInteract(interactor) && !EditorManager.Instance.IsEditing && !Player.Instance.Rider.IsRiding && MinigameManager.Instance.CurrentMinigame == null && FriendsManager.Instance.IsFriended(DataContainer.PlayerData.Value.playerId);
        }
