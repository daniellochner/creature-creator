...
namespace DanielLochner.Assets.CreatureCreator
{
    ...
    public class CreatureAbilities : NetworkBehaviour
    {
        ...
        public bool CanInput
        {
            get
            {
                return EditorManager.Instance.IsPlaying && !InputDialog.Instance.IsOpen && !ConfirmationDialog.Instance.IsOpen && !InformationDialog.Instance.IsOpen && (!PlayerChatMenu.Instance || !PlayerChatMenu.Instance.IsOpen);
            }
        }
        #endregion
