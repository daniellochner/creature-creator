...
#endif
    {
        if (!AssetDatabase.IsValidFolder("Assets/Plugins/External/Free/Google/GoogleMobileAds"))
        {
            AssetDatabase.CreateFolder("Assets/Plugins/External/Free/Google", "GoogleMobileAds");
        }
